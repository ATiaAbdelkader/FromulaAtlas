...
export const ALGERIA_CROPS: { id: string; name: string; emoji: string }[] = [
  ...
  { id: 'leek', name: 'Poireau', emoji: '🥬' },
  { id: 'lettuce', name: 'Laitue / salades', emoji: '🥬' },
  { id: 'artichoke', name: 'Artichaut', emoji: '🌼' },
  { id: 'asparagus', name: 'Asperge', emoji: '🍃' },
  { id: 'carrot', name: 'Carotte', emoji: '🥕' },
  { id: 'eggplant', name: 'Aubergine', emoji: '🍆' },
  { id: 'brassicas', name: 'Chou / choux-fleurs / brocoli', emoji: '🥦' },
  { id: 'peanut', name: 'Arachide', emoji: '🥜' },
  { id: 'oats', name: 'Avoine', emoji: '🌾' },
  { id: 'chickpea', name: 'Pois chiche', emoji: '🫘' },
  { id: 'tobacco', name: 'Tabac', emoji: '🚬' },
  // ---- Added 2026-08-08 — crops from Phase B web research ----
  { id: 'sorgho', name: 'Sorgho', emoji: '🌾' },
  { id: 'coton', name: 'Coton', emoji: '☁️' },
  { id: 'pistachier', name: 'Pistachier', emoji: '🌰' },
  { id: 'grenadier', name: 'Grenadier', emoji: '🔴' },
  { id: 'figuier', name: 'Figuier', emoji: '🟣' },
  { id: 'luzerne', name: 'Luzerne', emoji: '🌱' },
];
...
export const PLANT_PROBLEMS: PlantProblem[] = [
  ...
  { id: 'powdery-cereals', name: 'Oïdium des céréales (Blumeria graminis)', nameAr: 'البياض الدقيقي', type: 'disease', crops: ['wheat', 'barley', 'oats'], symptoms: ['oïdium', 'blanc', 'poudreuse', 'feuilles', 'blé'], actives: ['propiconazole', 'tebuconazole', 'azoxystrobine', 'soufre'], notes: 'Souvent favorisé par des semis denses et un excès d’azote ; intervenir sur les premières pustules blanches.' },
  ...
  { id: 'gray-mold', name: 'Pourriture grise / Botrytis', nameAr: 'العفن الرمادي', type: 'disease', crops: ['vine', 'tomato', 'strawberry', 'stonefruit', 'lettuce', 'artichoke'], symptoms: ['botrytis', 'pourriture grise', 'moisissure', 'grappes', 'fruits'], actives: ['iprodione', 'thiophanate-methyl', 'carbendazime'], notes: 'Travailler l’aération, éviter les blessures ; appliquer au début de la floraison et avant fermeture des grappes.' },
  { id: 'fusarium-head', name: 'Fusariose des épis (Fusarium graminearum)', type: 'disease', crops: ['wheat', 'barley', 'oats'], symptoms: ['fusariose', 'epis', 'blancs', 'echaudage', 'blé'], actives: ['tebuconazole', 'propiconazole', 'cyproconazole'], notes: 'Risque maximal si pluie + chaleur pendant la floraison ; traiter de la fin floraison au début de l’épiaison.' },
  { id: 'eyespot', name: 'Piétin-verse des céréales (Pseudocercosporella)', type: 'disease', crops: ['wheat', 'barley', 'oats'], symptoms: ['piétin', 'taches ovales', 'verse', 'base des tiges'], actives: ['cyproconazole', 'tebuconazole'], notes: 'Intervenir au tallage-épi 1 cm en cas de précédent blé et de printemps frais et humide.' },
  ...
  { id: 'anthracnose-legumes', name: 'Anthracnose / Ascochyta des légumineuses', type: 'disease', crops: ['legumes', 'chickpea'], symptoms: ['anthracnose', 'ascochyta', 'pois chiche', 'lentille', 'fève', 'taches noires'], actives: ['mancozebe', 'chlorothalonil', 'azoxystrobine'], notes: 'Utiliser des semences saines ; rotation longue ; traiter préventivement en végétation humide.' },
  { id: 'chocolate-spot', name: 'Botrytis de la fève (taches chocolat)', type: 'disease', crops: ['legumes', 'chickpea'], symptoms: ['chocolat', 'taches brunes', 'fève', 'botrytis'], actives: ['iprodione', 'thiophanate-methyl'], notes: 'Favorisé par la densité et l’humidité ; intervenir au début de la floraison si les conditions sont propices.' },
  ...
  { id: 'mites', name: 'Acariens / araignées rouges (Tetranychus, Panonychus)', nameAr: 'العنكبوت الأحمر', type: 'pest', crops: ['tomato', 'cucurbits', 'citrus', 'vine', 'strawberry', 'olive', 'apple', 'tobacco', 'eggplant', 'coton', 'grenadier'], symptoms: ['acariens', 'araignees rouges', 'taches jaunâtres', 'toiles', 'feuilles'], actives: ['abamectine', 'pyridabene', 'fenpyroximate', 'hexythiazox', 'bifenthrine', 'fenbutatin'], notes: 'Temps chaud et sec = risque ; alterner les groupes chimiques, le soufre peut aider en prévention sur certaines cultures.' },
  ...
  { id: 'sitona', name: 'Sitone du pois chiche (Sitona) et charançons des légumineuses', type: 'pest', crops: ['legumes', 'chickpea'], symptoms: ['sitone', 'charançon', 'encoches', 'feuilles', 'pois chiche'], actives: ['lambda-cyhalothrine', 'deltamethrine'], notes: 'Surveiller à la levée ; le seuil d’intervention est bas car les larves attaquent les nodosités.' },
  { id: 'clb', name: 'Criocère / lémas des céréales (Oulema)', type: 'pest', crops: ['wheat', 'barley', 'oats'], symptoms: ['criocere', 'lemas', 'feuilles striees', 'blé', 'larves'], actives: ['lambda-cyhalothrine', 'deltamethrine', 'cypermethrine'], notes: 'Intervenir si 10 % des feuilles portent des larves au stade montaison-épiaison.' },
  { id: 'hessefly', name: 'Mouche de Hesse / cécidomyies des céréales', type: 'pest', crops: ['wheat', 'barley', 'oats'], symptoms: ['mouche de hesse', 'cécidomyie', 'pieds cassés', 'blé'], actives: ['lambda-cyhalothrine', 'deltamethrine'], notes: 'Semis tardifs et destruction des repousses réduisent le risque ; traitement localisé en bordure.' },
  ...
  { id: 'broadleaf-veg', name: 'Dicotylédones des cultures maraîchères et industrielles', type: 'weed', crops: ['potato', 'tomato', 'onion', 'sugarbeet', 'sunflower', 'asparagus', 'brassicas', 'leek', 'carrot', 'eggplant'], symptoms: ['dicotylédones', 'maraîchage', 'betterave', 'tournesol'], actives: ['metribuzine', 'linuron', 'oxyfluorfene', 'pendimethaline', 'bentazone'], notes: 'Respecter les cultures et stades homologués ; la metribuzine s’emploie en pré-levée de la pomme de terre.' },
  { id: 'orobanche', name: 'Orobanche (plante parasite)', nameAr: 'الهالوك', type: 'weed', crops: ['legumes', 'tomato', 'sunflower', 'chickpea'], symptoms: ['orobanche', 'plante parasite', 'tiges roses', 'collet'], actives: ['glyphosate'], notes: 'Aucun herbicide n’est réellement curatif : solarisation, faux-semis, variétés résistantes, arrachage manuel avant floraison ; glyphosate en traitement localisé exceptionnel.' },
  ...
  // ---- Added 2026-08-08 — mined from the INPV 2017 usage lines ----
  { id: 'teigne-pommedeterre', name: 'Teigne de la pomme de terre (Phthorimaea operculella)', nameAr: 'فراشة البطاطا', type: 'pest', crops: ['potato'], symptoms: ['teigne', 'mineuse', 'tubercules', 'galeries', 'larves', 'feuilles'], actives: ['deltamethrine', 'cypermethrine', 'indoxacarbe', 'bifenthrine'], notes: 'INPV 2017 : 29 mentions (teigne pomme de terre). Intervenir sur les jeunes larves ; détruire les fanes et récolter tôt, éviter le stockage de tubercules attaqués.' },
  { id: 'psylle-poirier', name: 'Psylle du poirier (Cacopsylla pyri)', type: 'pest', crops: ['apple'], symptoms: ['psylle', 'miellat', 'fumagine', 'poirier', 'piqures', 'feuilles'], actives: ['cypermethrine', 'abamectine', 'lambda-cyhalothrine', 'deltamethrine'], notes: 'INPV 2017 : 17 mentions (psylle poirier). Le miellat favorise la fumagine ; traiter dès le début de végétation sur jeunes larves.' },
  { id: 'punaises-cereales', name: 'Punaises des céréales (Aelia, Eurygaster)', nameAr: 'بق الحبوب', type: 'pest', crops: ['wheat', 'barley', 'oats'], symptoms: ['punaise', 'piqures', 'grains', 'dégats', 'blé', 'orge'], actives: ['deltamethrine', 'chlorpyriphos-ethyl', 'alpha-cypermethrine', 'lambda-cyhalothrine'], notes: 'INPV 2017 : 13 mentions (punaises céréales). Les piqûres déprécient les grains (valeur boulangère) ; traiter les jeunes adultes au printemps.' },
  { id: 'cloque-pecher', name: 'Cloque du pêcher (Taphrina deformans)', nameAr: 'تجعّد أوراق الخوخ', type: 'disease', crops: ['stonefruit'], symptoms: ['cloque', 'feuilles', 'boursouflures', 'pêcher', 'rouge', 'déformation'], actives: ['cuivre', 'captan', 'mancozebe'], notes: 'INPV 2017 : 5 mentions (cloque pêcher). Traitement d’hiver au cuivre avant le débourrement ; répéter au gonflement des bourgeons.' },
  { id: 'black-rot-vigne', name: 'Black-rot de la vigne (Guignardia bidwellii)', type: 'disease', crops: ['vine'], symptoms: ['black-rot', 'taches', 'feuilles', 'grappes', 'fruits momifiés'], actives: ['tebuconazole', 'cuivre', 'mancozebe'], notes: 'INPV 2017 : 15 mentions (black-rot vigne). Surveiller après les pluies orageuses ; protéger feuilles et grappes jusqu’à la véraison.' },
  { id: 'carie', name: 'Carie du blé (Tilletia caries)', nameAr: 'التفحم الستي', type: 'disease', crops: ['wheat'], symptoms: ['carie', 'grains', 'odeur', 'sacs', 'épi'], actives: ['triticonazole', 'tebuconazole', 'flutriafol'], notes: 'INPV 2017 : traitement de semences ; les sacs de carie se répandent à la moisson.' },
  { id: 'charbon-cereales', name: 'Charbon nu / couvert des céréales (Ustilago, Tilletia)', type: 'disease', crops: ['wheat', 'barley', 'oats', 'sorgho'], symptoms: ['charbon', 'épis', 'grains noirs', 'poussière'], actives: ['tebuconazole', 'triticonazole', 'thiram'], notes: 'INPV 2017 : 5 mentions (charbon orge/blé). Traitement de semences, semences certifiées.' },
  { id: 'eudemis', name: 'Tordeuse / eudémis de la vigne (Lobesia botrana)', nameAr: 'دودة العنب', type: 'pest', crops: ['vine'], symptoms: ['eudemis', 'tordeuse', 'grappes', 'chenilles', 'ver de la grappe', 'perles'], actives: ['cypermethrine', 'fenoxycarb', 'lufenuron', 'chlorpyriphos-ethyl'], notes: 'INPV 2017 : 7 mentions (pyrale/tordeuse vigne). Confusion sexuelle possible ; viser les jeunes chenilles de la 2e génération.' },
  { id: 'cicadelle-vigne', name: 'Cicadelle de la vigne (Scaphoideus titanus, flavescence dorée)', type: 'pest', crops: ['vine'], symptoms: ['cicadelle', 'jaunissement', 'flavescence', 'feuilles', 'vigne'], actives: ['imidaclopride', 'flufenoxuron', 'lambda-cyhalothrine', 'acetamipride'], notes: 'INPV 2017 : 8 mentions (cicadelle vigne). La flavescence dorée est à déclaration obligatoire — traiter le vecteur.' },
  { id: 'altise-vigne', name: 'Altise de la vigne (Haltica ampelophaga)', type: 'pest', crops: ['vine'], symptoms: ['altise', 'coléoptère', 'feuilles grignotées', 'vigne'], actives: ['lambda-cyhalothrine', 'acetamipride', 'deltamethrine'], notes: 'INPV 2017 : 3 mentions (altise vigne). Sur jeunes pousses au printemps.' },
  { id: 'feu-bacterien', name: 'Feu bactérien (Erwinia amylovora)', nameAr: 'اللفحة النارية', type: 'disease', crops: ['apple'], symptoms: ['feu bactérien', 'brûlure', 'pointe', 'crosse', 'exsudat', 'écorce'], actives: ['cuivre'], notes: 'INPV 2017 : traitements au cuivre sanitaires ; arrachage des foyers, taille sanitaire, surveiller les exsudats.' },
  { id: 'rouille-poireau', name: 'Rouille du poireau / de l’ail (Puccinia allii)', type: 'disease', crops: ['leek', 'onion'], symptoms: ['rouille', 'pustules', 'poireau', 'ail', 'orangé'], actives: ['azoxystrobine', 'tebuconazole', 'fenhexamid'], notes: 'INPV 2017 : 3 mentions (rouille poireau). Aération et rotation ; traiter dès les premières pustules.' },
  { id: 'laitue-mildiou', name: 'Mildiou de la laitue (Bremia lactucae)', nameAr: 'البياض الزغبي للخس', type: 'disease', crops: ['lettuce'], symptoms: ['mildiou', 'laitue', 'blanc', 'feuilles', 'moisissure'], actives: ['mancozebe', 'metalaxyl-m', 'fosetyl-aluminium'], notes: 'Intervenir en préventif par temps frais et humide ; éviter les excès d’azote.' },
  { id: 'aubergine-mildiou', name: 'Mildiou / phytophthora de l’aubergine (Phytophthora capsici)', type: 'disease', crops: ['eggplant'], symptoms: ['mildiou', 'aubergine', 'taches', 'pourriture', 'collet'], actives: ['metalaxyl-m', 'mancozebe', 'cuivre'], notes: 'INPV 2017 : aleurodes surtout ; mildiou fréquent en serre humide.' },
  { id: 'carotte-mouche', name: 'Mouche de la carotte (Psila rosae)', nameAr: 'ذبابة الجزر', type: 'pest', crops: ['carrot'], symptoms: ['mouche', 'carotte', 'galeries', 'racines', 'larves'], actives: ['chlorpyriphos-ethyl', 'deltamethrine'], notes: 'INPV 2017 : 9 mentions carotte. Rotation longue et voile anti-insectes ; traitement en préventif.' },
  { id: 'rouille-asperge', name: 'Rouille de l’asperge (Puccinia asparagi)', type: 'disease', crops: ['asparagus'], symptoms: ['rouille', 'asperge', 'pustules', 'tiges'], actives: ['mancozebe', 'azoxystrobine', 'tebuconazole'], notes: 'INPV 2017 : 10 mentions asperge. Détruire les turions attaqués en fin de saison.' },
  { id: 'cercosporiose-arachide', name: 'Cercosporioses de l’arachide (Cercospora arachidicola, C. personata)', type: 'disease', crops: ['peanut'], symptoms: ['cercospora', 'taches', 'arachide', 'feuilles', 'chute'], actives: ['mancozebe', 'chlorothalonil', 'azoxystrobine'], notes: 'INPV 2017 : arachide (3 mentions). Taches foliaires par temps chaud et humide.' },
  { id: 'ascochyta-pois-chiche', name: 'Ascochyte du pois chiche (Ascochyta rabiei)', nameAr: 'الأنتراكنوز الحمص', type: 'disease', crops: ['chickpea'], symptoms: ['ascochyta', 'anthracnose', 'pois chiche', 'taches', 'tiges'], actives: ['mancozebe', 'azoxystrobine', 'chlorothalonil'], notes: 'INPV 2017 : anthracnose du pois chiche (2 mentions). Semences saines, rotation, variétés résistantes.' },
  { id: 'mildiou-tabac', name: 'Mildiou du tabac (Peronospora tabacina)', type: 'disease', crops: ['tobacco'], symptoms: ['mildiou', 'tabac', 'feuilles', 'bleuté'], actives: ['fosetyl-aluminium', 'mancozebe'], notes: 'INPV 2017 : tabac (6 mentions). Détruire les pieds atteints (maladie à déclaration).' },

  // ---- Added 2026-08-08 — Phase B, sourced from the web (EPPO / FAO / ITGC) ----
  { id: 'mouche-pousses-sorgho', name: 'Mouche des pousses du sorgho (Atherigona soccata)', type: 'pest', crops: ['sorgho'], symptoms: ['mouche', 'pousses', 'sorgho', 'cœur mort', 'larves', 'jaunissement'], actives: ['lambda-cyhalothrine', 'deltamethrine', 'chlorpyriphos-ethyl'], notes: 'Web (EPPO/FAO) 2026-08-08 : première mouche des céréales du sorgho en zones sèches ; semis précoces et destruction des talles attaquées limitent la pression.' },
  { id: 'foreurs-tiges', name: 'Foreurs des tiges (Sesamia, Chilo)', type: 'pest', crops: ['sorgho', 'maize'], symptoms: ['foreurs', 'tiges', 'galeries', 'cœur mort', 'sciure', 'sorgho', 'maïs'], actives: ['chlorantraniliprole', 'spinosad', 'lambda-cyhalothrine'], notes: 'Web (EPPO/FAO) 2026-08-08 : larves dans les tiges — casser les tiges attaquées après récolte, préférer les variétés à tige dure.' },
  { id: 'anthracnose-sorgho', name: 'Anthracnose du sorgho (Colletotrichum sublineolum)', type: 'disease', crops: ['sorgho'], symptoms: ['anthracnose', 'sorgho', 'taches', 'nervures', 'feuilles', 'chancres'], actives: ['mancozebe', 'azoxystrobine', 'chlorothalonil'], notes: 'Web (EPPO/FAO) 2026-08-08 : redoutable en zone humide ; rotation et variétés résistantes, traitements préventifs au tallage.' },
  { id: 'ver-rose-coton', name: 'Ver rose du cotonnier (Pectinophora gossypiella)', nameAr: 'دودة اللوز القرنفلية', type: 'pest', crops: ['coton'], symptoms: ['ver rose', 'coton', 'boutons', 'capses', 'fils', 'larves'], actives: ['chlorantraniliprole', 'emamectine', 'lambda-cyhalothrine', 'methomyl'], notes: 'Web (EPPO/FAO) 2026-08-08 : ravageur clé du coton en Algérie ; ramassage et enfouissement des capsules attaquées, contrôle des repousses.' },
  { id: 'anthracnose-coton', name: 'Anthracnose du cotonnier (Colletotrichum / Glomerella gossypii)', type: 'disease', crops: ['coton'], symptoms: ['anthracnose', 'coton', 'taches', 'capses', 'pourriture', 'tiges'], actives: ['mancozebe', 'azoxystrobine', 'chlorothalonil'], notes: 'Web (EPPO/FAO) 2026-08-08 : favorisée par l’humidité ; semences traitées et rotation, traitements préventifs en végétation.' },
  { id: 'verticilliose-coton', name: 'Flétrissement verticillien (Verticillium dahliae)', type: 'disease', crops: ['coton'], symptoms: ['verticilliose', 'flétrissement', 'coton', 'feuilles', 'défoliation', 'vaisseaux'], actives: ['thiophanate-methyl'], notes: 'Web (EPPO/FAO) 2026-08-08 : aucun curatif réel — rotation longue, variétés tolérantes, éviter les excès d’azote et d’eau.' },
  { id: 'psylle-pistachier', name: 'Psylle du pistachier (Agonoscena pistaciae)', type: 'pest', crops: ['pistachier'], symptoms: ['psylle', 'pistachier', 'miellat', 'fumagine', 'chute des feuilles', 'pigûres'], actives: ['acetamipride', 'imidaclopride', 'lambda-cyhalothrine', 'abamectine'], notes: 'Web (EPPO/FAO) 2026-08-08 : principal ravageur du pistachier — surveiller les jeunes pousses ; le miellat favorise la fumagine. Lutte biologique : Anthocoris minki.' },
  { id: 'taches-pistachier', name: 'Taches foliaires et rouille du pistachier (Septoria pistaciarum, Uromyces)', type: 'disease', crops: ['pistachier'], symptoms: ['septoria', 'taches', 'pistachier', 'rouille', 'feuilles', 'chute'], actives: ['mancozebe', 'difenoconazole', 'tebuconazole', 'azoxystrobine', 'soufre'], notes: 'Web (EPPO/FAO) 2026-08-08 : développer en été humide ; aération de la frondaison, traitements préventifs à partir du débourrement.' },
  { id: 'cochenille-grenadier', name: 'Cochenille blanche du grenadier (Ceraplastes russi)', nameAr: 'الحرشفية البيضاء', type: 'pest', crops: ['grenadier'], symptoms: ['cochenille', 'grenadier', 'miellat', 'fumagine', 'rameaux', 'boucliers'], actives: ['chlorpyriphos-ethyl', 'dimethoate', 'acetamipride'], notes: 'Web (EPPO/FAO) 2026-08-08 : cochenille blanche caractéristique du grenadier ; traitements d’hiver à l’huile + intervention estivale sur jeunes larves.' },
  { id: 'mouche-figuier', name: 'Mouche noire des figues (Silba adipata)', type: 'pest', crops: ['figuier'], symptoms: ['mouche', 'figuier', 'figues', 'pourriture', 'larves', 'chute'], actives: ['lambda-cyhalothrine', 'deltamethrine'], notes: 'Web (EPPO/FAO) 2026-08-08 : pond dans les figues — prophylaxie (ramassage des figues atteintes), piégeage, variétés tardives.' },
  { id: 'apion-luzerne', name: 'Apion de la luzerne (Apion pisi)', type: 'pest', crops: ['luzerne'], symptoms: ['apion', 'luzerne', 'boutons', 'graines', 'charançon', 'larves'], actives: ['lambda-cyhalothrine', 'deltamethrine'], notes: 'Web (EPPO/FAO) 2026-08-08 : ravageur de la luzerne porte-graine — faucher avant la formation des boutons, traitement au bouton floral si seuil atteint.' },
  { id: 'rouille-luzerne', name: 'Rouille de la luzerne (Uromyces striatus)', type: 'disease', crops: ['luzerne'], symptoms: ['rouille', 'luzerne', 'pustules', 'feuilles', 'chute'], actives: ['mancozebe', 'azoxystrobine', 'tebuconazole'], notes: 'Web (EPPO/FAO) 2026-08-08 : favorisée par l’humidité ; faucher tôt et souvent, variétés résistantes.' },
];
...
export const ALGERIAN_ACTIVE_MATTERS: ActiveMatter[] = [
  ...
  { id: 'bifenthrine', name: 'Bifenthrine 100 EC (Talstar)', activeSubstance: 'bifenthrine 100 g/L', type: 'insecticide', formulation: 'EC', crops: ['citrus', 'tomato', 'vine', 'strawberry', 'potato', 'apple', 'tobacco'], targets: ['mites', 'aphids', 'whitefly', 'thrips', 'teigne-pommedeterre', 'psylle-poirier'], resistanceCode: 'IRAC 3A', modeOfAction: 'Pyréthrinoïde — modulateur des canaux sodium', applicationRate: '0,4-0,8 L/ha', preHarvestInterval: '14 j', safetyLevel: 'high', cost: 'high', availability: 'moderate', restrictions: ['Très toxique pour les abeilles', 'Un seul traitement sur fruits'], alternatives: ['Abamectine', 'Pyridabène'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'chlorpyriphos-ethyl', name: 'Chlorpyriphos-éthyl 480 EC', activeSubstance: 'chlorpyriphos-éthyl 480 g/L', type: 'insecticide', formulation: 'EC', crops: ['potato', 'onion', 'maize', 'citrus', 'datepalm', 'carrot', 'vine', 'wheat', 'barley', 'sorgho', 'grenadier'], targets: ['wireworm', 'onionfly', 'blackscale', 'redweevil', 'termites', 'nematodes', 'carotte-mouche', 'eudemis', 'punaises-cereales', 'cochenille-grenadier'], resistanceCode: 'IRAC 1B', modeOfAction: 'Organophosphoré — inhibiteur des cholinestérases', applicationRate: '1,5-3 L/ha', preHarvestInterval: '21 j', safetyLevel: 'high', cost: 'low', availability: 'common', restrictions: ['Toxique (classe II OMS) — port des EPI obligatoire', 'Interdit en Europe — usage réglementé en Algérie'], alternatives: ['Fipronil', 'Imidaclopride'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'cypermethrine', name: 'Cyperméthrine 200 EC', activeSubstance: 'cyperméthrine 200 g/L', type: 'insecticide', formulation: 'EC', crops: ['wheat', 'barley', 'legumes', 'potato', 'apple', 'vine'], targets: ['clb', 'hessefly', 'aphids', 'locust', 'teigne-pommedeterre', 'psylle-poirier', 'eudemis'], resistanceCode: 'IRAC 3A', modeOfAction: 'Pyréthrinoïde — modulateur des canaux sodium', applicationRate: '0,2-0,4 L/ha', preHarvestInterval: '14 j', safetyLevel: 'medium', cost: 'low', availability: 'common', restrictions: ['Toxique abeilles', 'Éviter le ruissellement'], alternatives: ['Deltaméthrine', 'Lambda-cyhalothrine'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'deltamethrine', name: 'Decis 25 EC', activeSubstance: 'deltaméthrine 25 g/L', type: 'insecticide', formulation: 'EC', crops: ['olive', 'citrus', 'wheat', 'barley', 'vine', 'legumes', 'datepalm', 'apple', 'potato', 'sorgho', 'luzerne', 'figuier'], targets: ['medfly', 'olivefly', 'olivemoth', 'locust', 'clb', 'sitona', 'pyrale-dattes', 'psylle-poirier', 'teigne-pommedeterre', 'punaises-cereales', 'altise-vigne', 'carotte-mouche', 'mouche-pousses-sorgho', 'apion-luzerne', 'mouche-figuier'], resistanceCode: 'IRAC 3A', modeOfAction: 'Pyréthrinoïde — modulateur des canaux sodium', applicationRate: '0,3-0,6 L/ha', preHarvestInterval: '7-14 j', safetyLevel: 'medium', cost: 'low', availability: 'common', restrictions: ['Toxique pour les abeilles — éviter la floraison', 'Appâts recommandés contre la mouche des fruits'], alternatives: ['Lambda-cyhalothrine (Karate)', 'Alpha-cyperméthrine'], registeredAlgeria: true, source: 'inpv-2017' },
  ...
  // -------------------------------------------------------------- FONGICIDES
  { id: 'thiophanate-methyl', name: 'Thiophanate-méthyl 500 SC', activeSubstance: 'thiophanate-méthyl 500 g/L', type: 'fungicide', formulation: 'SC', crops: ['stonefruit', 'apple', 'legumes', 'datepalm', 'coton'], targets: ['monilia', 'gray-mold', 'scab-apple', 'chocolate-spot', 'bayoud', 'verticilliose-coton'], resistanceCode: 'FRAC 1', modeOfAction: 'Benzimidazole — inhibition de la tubuline', applicationRate: '0,5-1 L/ha', preHarvestInterval: '21 j', safetyLevel: 'medium', cost: 'low', availability: 'common', restrictions: ['Risque de résistance élevé — max 1-2 applications', 'Bayoud : désinfection des outils et du sol surtout'], alternatives: ['Iprodione', 'Captan'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'mancozebe', name: 'Dithane M-45 80 WP', activeSubstance: 'mancozèbe 800 g/kg', type: 'fungicide', formulation: 'WP', crops: ['potato', 'tomato', 'vine', 'onion', 'wheat', 'legumes', 'sugarbeet', 'apple', 'lettuce', 'eggplant', 'asparagus', 'peanut', 'chickpea', 'leek', 'sorgho', 'coton', 'pistachier', 'luzerne'], targets: ['mildew-potato', 'mildew-vine', 'mildew-onion', 'mildew-cucurbits', 'alternaria', 'septoria', 'anthracnose-legumes', 'cercospora-beet', 'scab-apple', 'peacock', 'rust-onion', 'laitue-mildiou', 'aubergine-mildiou', 'rouille-asperge', 'cercosporiose-arachide', 'ascochyta-pois-chiche', 'rouille-poireau', 'anthracnose-sorgho', 'anthracnose-coton', 'taches-pistachier', 'rouille-luzerne'], resistanceCode: 'FRAC M3', modeOfAction: 'Dithiocarbamate multisite — protecteur de contact', applicationRate: '1,5-2,5 kg/ha', preHarvestInterval: '7-21 j', safetyLevel: 'medium', cost: 'low', availability: 'common', restrictions: ['Traitement préventif exclusivement', 'Renouveler après pluie (> 20 mm)'], alternatives: ['Chlorothalonil', 'Cuivre'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'chlorothalonil', name: 'Chlorothalonil 720 SC', activeSubstance: 'chlorothalonil 720 g/L', type: 'fungicide', formulation: 'SC', crops: ['wheat', 'potato', 'tomato', 'legumes', 'peanut', 'chickpea', 'sorgho', 'coton'], targets: ['septoria', 'alternaria', 'anthracnose-legumes', 'cercosporiose-arachide', 'ascochyta-pois-chiche', 'anthracnose-sorgho', 'anthracnose-coton'], resistanceCode: 'FRAC M5', modeOfAction: 'Chloronitrile multisite — protecteur', applicationRate: '1,5-2 L/ha', preHarvestInterval: '14-21 j', safetyLevel: 'medium', cost: 'low', availability: 'common', restrictions: ['Interdit en Europe depuis 2020 — vérifier l’homologation INPV', 'Préventif uniquement'], alternatives: ['Mancozèbe', 'Azoxystrobine'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'cuivre', name: 'Bouillie bordelaise / oxychlorure de cuivre', activeSubstance: 'cuivre (sulfate/oxychlorure)', type: 'fungicide', formulation: 'WP', crops: ['vine', 'potato', 'tomato', 'olive', 'citrus', 'onion', 'apple', 'cucurbits', 'stonefruit', 'grenadier', 'figuier'], targets: ['mildew-vine', 'mildew-potato', 'mildew-onion', 'mildew-cucurbits', 'peacock', 'gummosis-citrus', 'alternaria', 'powdery-olive', 'cloque-pecher', 'black-rot-vigne'], resistanceCode: 'FRAC M1', modeOfAction: 'Multisite — protecteur de contact', applicationRate: '2-3 kg/ha (1,5 kg Cu métal max)', preHarvestInterval: '7-21 j', safetyLevel: 'low', cost: 'low', availability: 'common', restrictions: ['Utilisable en agriculture biologique (avec limites)', 'Éviter l’accumulation dans le sol'], alternatives: ['Mancozèbe', 'Métalaxyl-M'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'soufre', name: 'Soufre mouillable 80 WG', activeSubstance: 'soufre 800 g/kg', type: 'fungicide', formulation: 'WG', crops: ['vine', 'cucurbits', 'wheat', 'barley', 'olive', 'strawberry', 'pistachier'], targets: ['powdery-vine', 'powdery-cucurbits', 'powdery-cereals', 'powdery-olive', 'mites', 'taches-pistachier'], resistanceCode: 'FRAC M2', modeOfAction: 'Multisite — protecteur de contact', applicationRate: '2-4 kg/ha', preHarvestInterval: '1-7 j', safetyLevel: 'low', cost: 'low', availability: 'common', restrictions: ['Ne pas appliquer au-dessus de 30 °C (phytotoxicité)', 'Autorisé en agriculture biologique'], alternatives: ['Penconazole', 'Difenoconazole'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'difenoconazole', name: 'Score 250 EC', activeSubstance: 'difénoconazole 250 g/L', type: 'fungicide', formulation: 'EC', crops: ['vine', 'apple', 'onion', 'sugarbeet', 'stonefruit', 'pistachier'], targets: ['powdery-vine', 'powdery-cucurbits', 'rust-onion', 'scab-apple', 'cercospora-beet', 'peacock', 'taches-pistachier'], resistanceCode: 'FRAC 3', modeOfAction: 'Triazole (DMI) — inhibition de la biosynthèse des stérols', applicationRate: '0,3-0,5 L/ha', preHarvestInterval: '14-35 j', safetyLevel: 'medium', cost: 'medium', availability: 'common', restrictions: ['Max 3 applications', 'Alterner avec des multisites'], alternatives: ['Tébuconazole', 'Penconazole'], registeredAlgeria: true, source: 'inpv-2017' },
  ...
  { id: 'azoxystrobine', name: 'Amistar 25 SC', activeSubstance: 'azoxystrobine 250 g/L', type: 'fungicide', formulation: 'SC', crops: ['wheat', 'barley', 'potato', 'tomato', 'vine', 'cucurbits', 'legumes', 'sugarbeet', 'oats', 'leek', 'peanut', 'chickpea', 'asparagus', 'sorgho', 'coton', 'pistachier', 'luzerne'], targets: ['septoria', 'rust-wheat', 'powdery-cereals', 'mildew-potato', 'alternaria', 'powdery-cucurbits', 'anthracnose-legumes', 'cercospora-beet', 'rouille-poireau', 'rouille-asperge', 'cercosporiose-arachide', 'ascochyta-pois-chiche', 'anthracnose-sorgho', 'anthracnose-coton', 'taches-pistachier', 'rouille-luzerne'], resistanceCode: 'FRAC 11', modeOfAction: 'Strobilurine — inhibition du complexe III mitochondrial', applicationRate: '0,5-1 L/ha', preHarvestInterval: '7-35 j', safetyLevel: 'low', cost: 'high', availability: 'common', restrictions: ['Risque de résistance élevé — max 2 applications', 'Toujours associer à un multisite'], alternatives: ['Propiconazole', 'Tébuconazole'], registeredAlgeria: true, source: 'inpv-2017' },
  ...
  // ---- Ajout 2026-08-08 — substances issues du mining INPV 2017 (usages) ----
  { id: 'huile', name: 'Huile minérale paraffinique', activeSubstance: 'huile minérale 800 g/L', type: 'insecticide', formulation: 'EC', crops: ['citrus', 'olive', 'apple', 'stonefruit', 'grenadier', 'pistachier'], targets: ['blackscale', 'mites', 'medfly', 'leafminer', 'cochenille-grenadier', 'psylle-pistachier'], resistanceCode: 'n/a', modeOfAction: 'Huile — asphyxie des œufs et jeunes larves', applicationRate: '8-15 L/ha (0,5-1 %)', preHarvestInterval: '—', safetyLevel: 'low', cost: 'low', availability: 'common', restrictions: ['Ne pas appliquer à plus de 30 °C ni sur jeunes pousses', 'Traitement d’hiver contre cochenilles et œufs'], alternatives: ['Diméthoate', 'Diflubenzuron'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'acrinathrine', name: 'Acrinathrine 50 EC (Rufast)', activeSubstance: 'acrinathrine 50 g/L', type: 'insecticide', formulation: 'EC', crops: ['vine', 'apple', 'strawberry'], targets: ['mites', 'thrips', 'whitefly'], resistanceCode: 'IRAC 3A', modeOfAction: 'Pyréthrinoïde — modulateur des canaux sodium (effet acaricide)', applicationRate: '0,5-1 L/ha', preHarvestInterval: '21 j', safetyLevel: 'medium', cost: 'high', availability: 'moderate', restrictions: ['Toxique abeilles', 'Max 2 applications'], alternatives: ['Pyridabène', 'Bifenthrine'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'thiaclopride', name: 'Thiaclopride 480 SC (Calypso)', activeSubstance: 'thiaclopride 480 g/L', type: 'insecticide', formulation: 'SC', crops: ['apple', 'stonefruit'], targets: ['codlingmoth', 'aphids', 'psylle-poirier'], resistanceCode: 'IRAC 4A', modeOfAction: 'Néonicotinoïde — agoniste des récepteurs nicotiniques', applicationRate: '0,3-0,5 L/ha', preHarvestInterval: '14 j', safetyLevel: 'medium', cost: 'medium', availability: 'moderate', restrictions: ['Interdit en Europe depuis 2020 — vérifier l’homologation INPV', 'Risque pour les abeilles'], alternatives: ['Acétamipride', 'Lufénuron'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'lufenuron', name: 'Lufénuron 50 EC (Match)', activeSubstance: 'lufénuron 50 g/L', type: 'insecticide', formulation: 'EC', crops: ['tomato', 'vine', 'apple', 'citrus'], targets: ['tuta', 'eudemis', 'codlingmoth', 'citrusleafminer'], resistanceCode: 'IRAC 15', modeOfAction: 'Régulateur de croissance — inhibiteur de la synthèse de chitine', applicationRate: '0,3-0,4 L/ha', preHarvestInterval: '14 j', safetyLevel: 'low', cost: 'high', availability: 'moderate', restrictions: ['Agir sur jeunes larves (L1-L2)', 'Respectueux des auxiliaires adultes'], alternatives: ['Diflubenzuron', 'Spinosad'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'flufenoxuron', name: 'Flufénoxuron 100 DC (Cascade)', activeSubstance: 'flufénoxuron 100 g/L', type: 'insecticide', formulation: 'DC', crops: ['vine', 'apple', 'citrus'], targets: ['mites', 'codlingmoth', 'cicadelle-vigne', 'psylle-poirier'], resistanceCode: 'IRAC 15', modeOfAction: 'Régulateur de croissance — inhibiteur de la synthèse de chitine', applicationRate: '0,4-0,8 L/ha', preHarvestInterval: '14 j', safetyLevel: 'low', cost: 'high', availability: 'rare', restrictions: ['Ovicide/larvicide — intervenir en début de cycle', 'Vérifier la disponibilité locale'], alternatives: ['Lufénuron', 'Hexythiazox'], registeredAlgeria: false, source: 'ephy' },
  { id: 'fenoxycarb', name: 'Fénoxycarb 250 WG (Insegar)', activeSubstance: 'fénoxycarb 250 g/kg', type: 'insecticide', formulation: 'WG', crops: ['vine', 'apple', 'citrus'], targets: ['eudemis', 'codlingmoth', 'blackscale', 'pyrale-dattes'], resistanceCode: 'IRAC 7B', modeOfAction: 'Régulateur de croissance — analogue de l’hormone juvénile', applicationRate: '0,3-0,6 kg/ha', preHarvestInterval: '14 j', safetyLevel: 'low', cost: 'medium', availability: 'moderate', restrictions: ['Positionner selon les vols (eudémis)', 'Inefficace sur adultes'], alternatives: ['Lufénuron', 'Bacillus thuringiensis'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'buprofezin', name: 'Buprofézine 250 SC (Applaud)', activeSubstance: 'buprofézine 250 g/L', type: 'insecticide', formulation: 'SC', crops: ['citrus', 'olive', 'vine'], targets: ['whitefly', 'blackscale', 'cicadelle-vigne'], resistanceCode: 'IRAC 16', modeOfAction: 'Régulateur de croissance — inhibiteur de la synthèse de chitine', applicationRate: '0,4-0,6 L/ha', preHarvestInterval: '21 j', safetyLevel: 'low', cost: 'medium', availability: 'moderate', restrictions: ['Agir sur jeunes larves', 'Préserve les auxiliaires'], alternatives: ['Diflubenzuron', 'Acétamipride'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'pymetrozine', name: 'Pymétrozine 250 WG (Plenum)', activeSubstance: 'pymétrozine 250 g/kg', type: 'insecticide', formulation: 'WG', crops: ['tomato', 'cucurbits', 'potato'], targets: ['aphids', 'whitefly'], resistanceCode: 'IRAC 9B', modeOfAction: 'Pyridine azométhine — anti-nourrissage sélectif pucerons', applicationRate: '0,3-0,5 kg/ha', preHarvestInterval: '7 j', safetyLevel: 'low', cost: 'high', availability: 'rare', restrictions: ['Intervenir précocement sur foyers', 'Bonne sélectivité vis-à-vis des auxiliaires'], alternatives: ['Acétamipride', 'Spinosad'], registeredAlgeria: false, source: 'ephy' },
  { id: 'spirodiclofen', name: 'Spirodiclofen 240 SC (Envidor)', activeSubstance: 'spirodiclofen 240 g/L', type: 'acaricide', formulation: 'SC', crops: ['citrus', 'vine', 'apple'], targets: ['mites'], resistanceCode: 'IRAC 23', modeOfAction: 'Tétronique — inhibition de la synthèse des lipides', applicationRate: '0,3-0,5 L/ha', preHarvestInterval: '14-21 j', safetyLevel: 'medium', cost: 'high', availability: 'rare', restrictions: ['Action lente — intervenir tôt', 'Max 1-2 applications'], alternatives: ['Pyridabène', 'Hexythiazox'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'propargite', name: 'Propargite 570 EC (Omite)', activeSubstance: 'propargite 570 g/L', type: 'acaricide', formulation: 'EC', crops: ['citrus', 'vine', 'apple', 'tomato'], targets: ['mites'], resistanceCode: 'IRAC 12C', modeOfAction: 'Sulfite d’ester — inhibition de la phosphorylation oxydative', applicationRate: '0,8-1,5 L/ha', preHarvestInterval: '21 j', safetyLevel: 'medium', cost: 'low', availability: 'moderate', restrictions: ['Bien mouiller les deux faces des feuilles', 'Max 2 applications'], alternatives: ['Pyridabène', 'Abamectine'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'hexaconazole', name: 'Hexaconazole 100 EC', activeSubstance: 'hexaconazole 100 g/L', type: 'fungicide', formulation: 'EC', crops: ['apple', 'wheat', 'legumes'], targets: ['scab-apple', 'rust-wheat', 'powdery-cereals', 'anthracnose-legumes'], resistanceCode: 'FRAC 3', modeOfAction: 'Triazole (DMI) — inhibition de la biosynthèse des stérols', applicationRate: '0,3-0,5 L/ha', preHarvestInterval: '14-35 j', safetyLevel: 'low', cost: 'low', availability: 'common', restrictions: ['Max 3 applications', 'Alterner avec des multisites'], alternatives: ['Difénoconazole', 'Tébuconazole'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'triadimenol', name: 'Triadiménol 250 EC (Bayfidan)', activeSubstance: 'triadiménol 250 g/L', type: 'fungicide', formulation: 'EC', crops: ['wheat', 'barley', 'vine'], targets: ['rust-wheat', 'powdery-cereals', 'powdery-vine'], resistanceCode: 'FRAC 3', modeOfAction: 'Triazole (DMI)', applicationRate: '0,4-0,6 L/ha', preHarvestInterval: '21-35 j', safetyLevel: 'low', cost: 'low', availability: 'moderate', restrictions: ['Max 2 applications', 'Bien positionner avant la floraison'], alternatives: ['Tébuconazole', 'Propiconazole'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'triticonazole', name: 'Triticonazole 80 SC (Real)', activeSubstance: 'triticonazole 80 g/L', type: 'fungicide', formulation: 'SC', crops: ['wheat', 'barley'], targets: ['carie', 'charbon-cereales', 'rust-wheat'], resistanceCode: 'FRAC 3', modeOfAction: 'Triazole (DMI) — traitement de semences', applicationRate: '0,3-0,4 L/ha (semences)', preHarvestInterval: '—', safetyLevel: 'low', cost: 'medium', availability: 'moderate', restrictions: ['Traitement de semences principalement', 'Ne pas semer de semences trop humides'], alternatives: ['Tébuconazole', 'Flutriafol'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'thiram', name: 'Thirame 80 WG', activeSubstance: 'thiram 800 g/kg', type: 'fungicide', formulation: 'WG', crops: ['wheat', 'barley', 'legumes', 'sugarbeet'], targets: ['carie', 'charbon-cereales', 'anthracnose-legumes'], resistanceCode: 'FRAC M3', modeOfAction: 'Dithiocarbamate multisite — traitement de semences/contact', applicationRate: '1,5-2 kg/ha (semences : 150-200 g/q)', preHarvestInterval: '—', safetyLevel: 'medium', cost: 'low', availability: 'common', restrictions: ['Protecteur — préventif uniquement', 'Éviter le contact cutané'], alternatives: ['Triticonazole', 'Mancozèbe'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'propinebe', name: 'Propinèbe 700 WP (Antracol)', activeSubstance: 'propinèbe 700 g/kg', type: 'fungicide', formulation: 'WP', crops: ['vine', 'potato', 'tomato', 'onion'], targets: ['mildew-vine', 'mildew-potato', 'alternaria', 'mildew-onion'], resistanceCode: 'FRAC M3', modeOfAction: 'Dithiocarbamate multisite — protecteur de contact', applicationRate: '1,5-2,5 kg/ha', preHarvestInterval: '7-21 j', safetyLevel: 'medium', cost: 'low', availability: 'common', restrictions: ['Préventif — renouveler après pluie', 'Max 4-6 applications'], alternatives: ['Mancozèbe', 'Cuivre'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'fenhexamid', name: 'Fenhexamide 500 WG (Teldor)', activeSubstance: 'fenhexamide 500 g/kg', type: 'fungicide', formulation: 'WG', crops: ['vine', 'strawberry', 'stonefruit'], targets: ['gray-mold', 'monilia'], resistanceCode: 'FRAC 17', modeOfAction: 'Hydroxyanilide — inhibition de la biosynthèse des stérols (botrytis)', applicationRate: '0,5-1 kg/ha', preHarvestInterval: '7-14 j', safetyLevel: 'low', cost: 'medium', availability: 'moderate', restrictions: ['Spécialisé botrytis/moniliose', 'Max 2-3 applications'], alternatives: ['Iprodione', 'Thiophanate-méthyl'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'dimethomorph', name: 'Diméthomorphe 500 SC (Acrobat)', activeSubstance: 'diméthomorphe 500 g/L', type: 'fungicide', formulation: 'SC', crops: ['vine', 'potato', 'tomato', 'onion'], targets: ['mildew-vine', 'mildew-potato', 'mildew-cucurbits'], resistanceCode: 'FRAC 40', modeOfAction: 'Acide cinnamique — action anti-mildiou translaminaire', applicationRate: '0,3-0,5 L/ha', preHarvestInterval: '7-14 j', safetyLevel: 'low', cost: 'medium', availability: 'moderate', restrictions: ['Curatif précoce — associer un multisite', 'Max 3-4 applications'], alternatives: ['Métalaxyl-M', 'Cymoxanil'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'spiroxamine', name: 'Spiroxamine 500 EC (Prosper)', activeSubstance: 'spiroxamine 500 g/L', type: 'fungicide', formulation: 'EC', crops: ['wheat', 'barley', 'vine'], targets: ['powdery-cereals', 'powdery-vine', 'septoria'], resistanceCode: 'FRAC 5', modeOfAction: 'Spirocétalamine — inhibition de la biosynthèse des stérols', applicationRate: '0,4-0,6 L/ha', preHarvestInterval: '21-35 j', safetyLevel: 'low', cost: 'medium', availability: 'moderate', restrictions: ['Spécialisé oïdium', 'Max 2 applications'], alternatives: ['Tébuconazole', 'Soufre'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'triforine', name: 'Triforine 190 EC (Saprol)', activeSubstance: 'triforine 190 g/L', type: 'fungicide', formulation: 'EC', crops: ['apple', 'vine'], targets: ['scab-apple', 'powdery-vine', 'peacock'], resistanceCode: 'FRAC 5', modeOfAction: 'Inhibiteur de la biosynthèse des stérols (anti-oïdium)', applicationRate: '0,5-1 L/ha', preHarvestInterval: '14 j', safetyLevel: 'low', cost: 'low', availability: 'moderate', restrictions: ['Éviter les fortes chaleurs', 'Max 3 applications'], alternatives: ['Myclobutanil', 'Soufre'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'proquinazid', name: 'Proquinazid 200 SC (Talius)', activeSubstance: 'proquinazid 200 g/L', type: 'fungicide', formulation: 'SC', crops: ['wheat', 'barley'], targets: ['powdery-cereals'], resistanceCode: 'FRAC 13', modeOfAction: 'Quinazoline — inhibition de la biosynthèse de l’ergostérol', applicationRate: '0,2-0,4 L/ha', preHarvestInterval: '35 j', safetyLevel: 'low', cost: 'high', availability: 'rare', restrictions: ['Spécialisé oïdium des céréales', 'Associer un multisite'], alternatives: ['Tébuconazole', 'Spiroxamine'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'tefluthrine', name: 'Téfluthrine 20 g/kg (Force, semences)', activeSubstance: 'téfluthrine 20 g/kg', type: 'insecticide', formulation: 'FS/GR', crops: ['maize', 'wheat', 'barley', 'sugarbeet'], targets: ['wireworm'], resistanceCode: 'IRAC 3A', modeOfAction: 'Pyréthrinoïde — traitement de semences contre taupins', applicationRate: '2-5 kg de semences traitées/q', preHarvestInterval: '—', safetyLevel: 'medium', cost: 'medium', availability: 'rare', restrictions: ['Traitement de semences uniquement', 'Respecter le délai semis-récolte'], alternatives: ['Fipronil', 'Imidaclopride'], registeredAlgeria: false, source: 'ephy' },
  { id: 'teflubenzuron', name: 'Téflubenzuron 150 SC (Nomolt)', activeSubstance: 'téflubenzuron 150 g/L', type: 'insecticide', formulation: 'SC', crops: ['apple', 'citrus'], targets: ['psylle-poirier', 'codlingmoth', 'leafminer'], resistanceCode: 'IRAC 15', modeOfAction: 'Régulateur de croissance — inhibiteur de la synthèse de chitine', applicationRate: '0,3-0,5 L/ha', preHarvestInterval: '14 j', safetyLevel: 'low', cost: 'medium', availability: 'rare', restrictions: ['Agir sur jeunes larves', 'Spécialisé psylle du poirier'], alternatives: ['Lufénuron', 'Diflubenzuron'], registeredAlgeria: false, source: 'ephy' },
];
