...
export const PLANT_PROBLEMS: PlantProblem[] = [
  ...
  { id: 'mites', name: 'Acariens / araignées rouges (Tetranychus, Panonychus)', nameAr: 'العنكبوت الأحمر', type: 'pest', crops: ['tomato', 'cucurbits', 'citrus', 'vine', 'strawberry', 'olive', 'apple', 'tobacco', 'eggplant'], symptoms: ['acariens', 'araignees rouges', 'taches jaunâtres', 'toiles', 'feuilles'], actives: ['abamectine', 'pyridabene', 'fenpyroximate', 'hexythiazox', 'bifenthrine', 'fenbutatin'], notes: 'Temps chaud et sec = risque ; alterner les groupes chimiques, le soufre peut aider en prévention sur certaines cultures.' },
  ...
  { id: 'charbon-cereales', name: 'Charbon nu / couvert des céréales (Ustilago, Tilletia)', type: 'disease', crops: ['wheat', 'barley', 'oats'], symptoms: ['charbon', 'épis', 'grains noirs', 'poussière'], actives: ['tebuconazole', 'triticonazole', 'thiram'], notes: 'INPV 2017 : 5 mentions (charbon orge/blé). Traitement de semences, semences certifiées.' },
...
export const ALGERIAN_ACTIVE_MATTERS: ActiveMatter[] = [
  ...
  { id: 'chlorpyriphos-ethyl', name: 'Chlorpyriphos-éthyl 480 EC', activeSubstance: 'chlorpyriphos-éthyl 480 g/L', type: 'insecticide', formulation: 'EC', crops: ['potato', 'onion', 'maize', 'citrus', 'datepalm', 'carrot', 'vine', 'wheat', 'barley'], targets: ['wireworm', 'onionfly', 'blackscale', 'redweevil', 'termites', 'nematodes', 'carotte-mouche', 'eudemis', 'punaises-cereales'], resistanceCode: 'IRAC 1B', modeOfAction: 'Organophosphoré — inhibiteur des cholinestérases', applicationRate: '1,5-3 L/ha', preHarvestInterval: '21 j', safetyLevel: 'high', cost: 'low', availability: 'common', restrictions: ['Toxique (classe II OMS) — port des EPI obligatoire', 'Interdit en Europe — usage réglementé en Algérie'], alternatives: ['Fipronil', 'Imidaclopride'], registeredAlgeria: true, source: 'inpv-2017' },
  ...
  { id: 'deltamethrine', name: 'Decis 25 EC', activeSubstance: 'deltaméthrine 25 g/L', type: 'insecticide', formulation: 'EC', crops: ['olive', 'citrus', 'wheat', 'barley', 'vine', 'legumes', 'datepalm', 'apple', 'potato'], targets: ['medfly', 'olivefly', 'olivemoth', 'locust', 'clb', 'sitona', 'pyrale-dattes', 'psylle-poirier', 'teigne-pommedeterre', 'punaises-cereales', 'altise-vigne', 'carotte-mouche'], resistanceCode: 'IRAC 3A', modeOfAction: 'Pyréthrinoïde — modulateur des canaux sodium', applicationRate: '0,3-0,6 L/ha', preHarvestInterval: '7-14 j', safetyLevel: 'medium', cost: 'low', availability: 'common', restrictions: ['Toxique pour les abeilles — éviter la floraison', 'Appâts recommandés contre la mouche des fruits'], alternatives: ['Lambda-cyhalothrine (Karate)', 'Alpha-cyperméthrine'], registeredAlgeria: true, source: 'inpv-2017' },
  ...
  { id: 'mancozebe', name: 'Dithane M-45 80 WP', activeSubstance: 'mancozèbe 800 g/kg', type: 'fungicide', formulation: 'WP', crops: ['potato', 'tomato', 'vine', 'onion', 'wheat', 'legumes', 'sugarbeet', 'apple', 'lettuce', 'eggplant', 'asparagus', 'peanut', 'chickpea', 'leek'], targets: ['mildew-potato', 'mildew-vine', 'mildew-onion', 'mildew-cucurbits', 'alternaria', 'septoria', 'anthracnose-legumes', 'cercospora-beet', 'scab-apple', 'peacock', 'rust-onion', 'laitue-mildiou', 'aubergine-mildiou', 'rouille-asperge', 'cercosporiose-arachide', 'ascochyta-pois-chiche', 'rouille-poireau'], resistanceCode: 'FRAC M3', modeOfAction: 'Dithiocarbamate multisite — protecteur de contact', applicationRate: '1,5-2,5 kg/ha', preHarvestInterval: '7-21 j', safetyLevel: 'medium', cost: 'low', availability: 'common', restrictions: ['Traitement préventif exclusivement', 'Renouveler après pluie (> 20 mm)'], alternatives: ['Chlorothalonil', 'Cuivre'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'chlorothalonil', name: 'Chlorothalonil 720 SC', activeSubstance: 'chlorothalonil 720 g/L', type: 'fungicide', formulation: 'SC', crops: ['wheat', 'potato', 'tomato', 'legumes', 'peanut', 'chickpea'], targets: ['septoria', 'alternaria', 'anthracnose-legumes', 'cercosporiose-arachide', 'ascochyta-pois-chiche'], resistanceCode: 'FRAC M5', modeOfAction: 'Chloronitrile multisite — protecteur', applicationRate: '1,5-2 L/ha', preHarvestInterval: '14-21 j', safetyLevel: 'medium', cost: 'low', availability: 'common', restrictions: ['Interdit en Europe depuis 2020 — vérifier l’homologation INPV', 'Préventif uniquement'], alternatives: ['Mancozèbe', 'Azoxystrobine'], registeredAlgeria: true, source: 'inpv-2017' },
  { id: 'cuivre', name: 'Bouillie bordelaise / oxychlorure de cuivre', activeSubstance: 'cuivre (sulfate/oxychlorure)', type: 'fungicide', formulation: 'WP', crops: ['vine', 'potato', 'tomato', 'olive', 'citrus', 'onion', 'apple', 'cucurbits', 'stonefruit'], targets: ['mildew-vine', 'mildew-potato', 'mildew-onion', 'mildew-cucurbits', 'peacock', 'gummosis-citrus', 'alternaria', 'powdery-olive', 'cloque-pecher', 'black-rot-vigne'], resistanceCode: 'FRAC M1', modeOfAction: 'Multisite — protecteur de contact', applicationRate: '2-3 kg/ha (1,5 kg Cu métal max)', preHarvestInterval: '7-21 j', safetyLevel: 'low', cost: 'low', availability: 'common', restrictions: ['Utilisable en agriculture biologique (avec limites)', 'Éviter l’accumulation dans le sol'], alternatives: ['Mancozèbe', 'Métalaxyl-M'], registeredAlgeria: true, source: 'inpv-2017' },
  ...
  { id: 'azoxystrobine', name: 'Amistar 25 SC', activeSubstance: 'azoxystrobine 250 g/L', type: 'fungicide', formulation: 'SC', crops: ['wheat', 'barley', 'potato', 'tomato', 'vine', 'cucurbits', 'legumes', 'sugarbeet', 'oats', 'leek', 'peanut', 'chickpea', 'asparagus'], targets: ['septoria', 'rust-wheat', 'powdery-cereals', 'mildew-potato', 'alternaria', 'powdery-cucurbits', 'anthracnose-legumes', 'cercospora-beet', 'rouille-poireau', 'rouille-asperge', 'cercosporiose-arachide', 'ascochyta-pois-chiche'], resistanceCode: 'FRAC 11', modeOfAction: 'Strobilurine — inhibition du complexe III mitochondrial', applicationRate: '0,5-1 L/ha', preHarvestInterval: '7-35 j', safetyLevel: 'low', cost: 'high', availability: 'common', restrictions: ['Risque de résistance élevé — max 2 applications', 'Toujours associer à un multisite'], alternatives: ['Propiconazole', 'Tébuconazole'], registeredAlgeria: true, source: 'inpv-2017' },
