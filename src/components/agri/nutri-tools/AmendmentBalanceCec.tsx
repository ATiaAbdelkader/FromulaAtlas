...
const TITLE: TrilingualString = {
  en: 'Soil CEC Cation Balance & Base Saturation Solver',
  ar: 'حاسبة توازن الكاتيونات والمحسنات حسب السعة التبادلية (CEC)',
  fr: 'Équilibre Cationique & Amendements par CEC',
};

const DESC: TrilingualString = {
  en: 'Calculates exact agricultural lime, gypsum, magnesium sulfate, and SOP amendment requirements to achieve ideal base saturation ratios (Ca 65-75%, Mg 10-15%, K 3-5%, Na < 3%).',
  ar: 'حساب دقيق لجرعات الجير الزراعي والجبس وسلفات المغنيسيوم وسلفات البوتاسيوم لتحقيق التوازن المثالي لمعقد الامتصاص.',
  fr: 'Calculez précisément les doses de chaux, gypse, sulfate de magnésie et sulfate de potasse pour atteindre la saturation idéale en bases.',
};
  ...
  return (
    <CalculatorShell
      ...
      actions={[
        ...
        {
          icon: RotateCcw,
          label: { en: 'Reset', ar: 'إعادة ضبط', fr: 'Réinitialiser' },
          onClick: reset,
        },
      ]}
    >
      {/* Quick Toolbar (Crop Preset + Equilibrium Equations badge) */}
      ...
      {/* Bridge Banner */}
      {bridgeBanner && (
        <div className="lg:col-span-12 rounded-2xl border border-emerald-300 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/40 p-4 flex items-start justify-between gap-3 shadow-xs">
      ...
      {preset && (
        <div className="lg:col-span-12 rounded-2xl border border-emerald-300 dark:border-emerald-800 bg-emerald-50/70 dark:bg-emerald-950/30 p-4 space-y-3">
