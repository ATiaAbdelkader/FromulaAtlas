  ...
  return (
    <Card className="overflow-hidden border-blue-200/60 shadow-sm dark:border-blue-900/60">
      <CardHeader className="border-b bg-gradient-to-r from-blue-50 via-background to-cyan-50/40 pb-4 dark:from-blue-950/30 dark:via-background dark:to-cyan-950/20">
        ...
        <p className="mt-1 text-xs leading-relaxed text-muted-foreground">Radiative vs advective frost · sprinkler / wind machine / smudge pot sizing</p>
      </CardHeader>
      <CardContent className="space-y-5 p-4 sm:p-5">
        <div className="grid grid-cols-2 gap-3 rounded-xl border bg-muted/20 p-3 sm:grid-cols-4">
          ...
          <div>
            <Label className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Dew point (°C)</Label>
        ...
        <div>
          <Label className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Protection method</Label>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
              <div className={`rounded-xl border p-3 shadow-sm ${result.isFrost ? 'border-blue-300 bg-blue-50/40' : 'border-emerald-300 bg-emerald-50/40'}`}>
                <div className="text-[10px] font-medium uppercase tracking-wide text-muted-foreground">Frost type</div>
                <div className="mt-1 text-base font-bold">{result.isFrost ? (result.isAdvective ? 'Advective (wind)' : 'Radiative (calm)') : 'No frost'}</div>
              </div>
              <div className="rounded-md border p-2">
                <div className="text-[10px] font-medium uppercase tracking-wide text-muted-foreground">Effectiveness</div>
