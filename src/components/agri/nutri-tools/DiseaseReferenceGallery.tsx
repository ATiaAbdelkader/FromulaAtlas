...
const CROP_AR: Record<string, string> = { Tomato: 'الطماطم', Potato: 'البطاطا', Pepper: 'الفلفل', Corn: 'الذرة', Wheat: 'القمح', Apple: 'التفاح', Grape: 'العنب', Rice: 'الأرز', Citrus: 'الحمضيات', Strawberry: 'الفراولة', Cashew: 'الكاجو', Cassava: 'الكاسافا', General: 'عام' };
const CROP_FR: Record<string, string> = { Tomato: 'Tomate', Potato: 'Pomme de terre', Pepper: 'Poivron', Corn: 'Maïs', Wheat: 'Blé', Apple: 'Pomme', Grape: 'Raisin', Rice: 'Riz', Citrus: 'Agrumes', Strawberry: 'Fraise', Cashew: 'Anacardier', Cassava: 'Manioc', General: 'Général' };
const DISEASE_AR: Record<string, string> = {
  'tom-early-blight': 'اللفحة المبكرة', 'tom-late-blight': 'اللفحة المتأخرة', 'tom-leaf-mold': 'عفن الأوراق', 'tom-septoria': 'تبقع أوراق السيبتوريا', 'tom-spider-mites': 'العنكبوت الأحمر', 'tom-leaf-curl-virus': 'فيروس تجعد أوراق الطماطم', 'tom-mosaic-virus': 'فيروس موزاييك الطماطم', 'pot-early-blight': 'اللفحة المبكرة', 'pot-late-blight': 'اللفحة المتأخرة', 'pep-bacterial-spot': 'التبقع البكتيري', 'corn-gray-leaf-spot': 'تبقع الأوراق الرمادي', 'corn-rust': 'الصدأ الشائع', 'corn-northern-blight': 'اللفحة الشمالية للذرة', 'wheat-stripe-rust': 'الصدأ المخطط', 'wheat-leaf-rust': 'صدأ الأوراق', 'apple-scab': 'جرب التفاح', 'apple-cedar-rust': 'صدأ التفاح والأرز', 'grape-black-rot': 'العفن الأسود', 'grape-esca': 'مرض إيسكا', 'rice-brown-spot': 'التبقع البني', 'rice-leaf-blast': 'لفحة الأرز', 'citrus-greening': 'اخضرار الحمضيات', 'straw-leaf-scorch': 'لفحة أوراق الفراولة', 'cashew-anthracnose': 'الأنثراكنوز', 'cashew-gummosis': 'إفراز الصمغ (الجوموز)', 'cashew-healthy': 'الكاجو — سليم', 'cashew-leaf-miner': 'ناخرة الأوراق', 'cashew-red-rust': 'الصدأ الأحمر', 'cassava-bacterial-blight': 'اللفحة البكتيرية للكسافا', 'cassava-brown-spot': 'البقعة البنية', 'cassava-green-mite': 'العنكبوت الأخضر', 'cassava-healthy': 'الكاسافا — سليم', 'cassava-mosaic': 'فسيفساء الكاسافا', 'maize-fall-armyworm': 'دودة الجيش الخريفية', 'maize-grasshopper': 'أضرار الجراد', 'maize-leaf-beetle': 'أضرار الخنافس الآكلة للأوراق', 'maize-leaf-spot': 'تبقع الأوراق الجنوبي', 'maize-streak-virus': 'فيروس تخطيط الذرة', 'maize-lethal-necrosis': 'النخر المميت للذرة', 'weed-chinee-apple': 'تفاح صيني', 'weed-lantana': 'اللانتانا', 'weed-parkinsonia': 'الباركنسونيا', 'weed-parthenium': 'البارثينيوم', 'weed-prickly-acacia': 'الأكاسيا الشوكية', 'weed-rubber-vine': 'الكرمة المطاطية', 'weed-siam-weed': 'حشيشة سيام', 'weed-snake-weed': 'حشيشة الثعبان',
};
