      ...
      <nav className={`fixed top-0 inset-x-0 z-50 transition-all ${scrolled ? 'bg-background/95 backdrop-blur-md border-b shadow-sm py-2' : 'bg-transparent py-4'}`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-xs">
            ...
            <Link href="/" className="text-muted-foreground hover:text-foreground transition-colors">Open App</Link>
          </div>
          <Link href="/" className="flex items-center gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg bg-gradient-to-r from-emerald-600 to-green-700 text-white text-xs sm:text-sm font-medium hover:shadow-lg hover:scale-105 transition-all">
      ...
      <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
            {FORMULA_COUNT} agronomic formulas. {INTERACTIVE_TOOL_COUNT} interactive tools. GIS, AI specialists, irrigation scheduling, and FAO-56 ET₀ — all in one platform. Built by a researcher, for farmers, agronomists, and students.
          </p>

          {/* CTAs */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-12">
            <Link href="/" className="group flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-600 to-green-700 text-white font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all">
      ...
      <section id="stats" className="py-12 border-y bg-gradient-to-r from-emerald-50/50 via-cyan-50/30 to-violet-50/50 dark:from-emerald-950/20 dark:via-cyan-950/10 dark:to-violet-950/20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-8">
            <StatCounter icon={BookOpen} value={FORMULA_COUNT} label="Agronomic formulas" color="#f59e0b" />
            <StatCounter icon={Calculator} value={INTERACTIVE_TOOL_COUNT} label="Interactive tools" color="#0891b2" />
          ...
          <div className="rounded-2xl border bg-card p-6 sm:p-10 min-h-[320px]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <Link href="/" className="inline-flex items-center gap-1.5 mt-5 text-sm font-medium text-emerald-600 hover:text-emerald-700">
      ...
      <section className="py-20 bg-muted/20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-3">{INTERACTIVE_TOOL_COUNT} tools, zero friction</h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="rounded-3xl bg-gradient-to-br from-emerald-700 via-green-700 to-teal-800 text-white p-10 sm:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <Link href="/" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white text-emerald-700 font-bold text-base shadow-lg hover:shadow-xl hover:scale-105 transition-all">
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mt-8 text-xs text-emerald-100">
                ...
                <span className="flex items-center gap-1"><Check className="h-3 w-3" /> {CALCULATOR_COUNT} free calculators</span>
