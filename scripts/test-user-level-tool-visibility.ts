...
assert(JSON.stringify(getUserLevelTabs('farmer')) === JSON.stringify(['home', 'farmpilot', 'myfield', 'farm', 'calendar', 'simulator', 'help', 'guide', 'about']), 'Farmer mobile navigation must expose every permitted destination');
assert(JSON.stringify(getUserLevelTabs('manager')) === JSON.stringify(['home', 'farmpilot', 'farm', 'calendar', 'simulator', 'insights', 'tools', 'help', 'guide', 'about']), 'Manager mobile navigation must expose every permitted destination');
